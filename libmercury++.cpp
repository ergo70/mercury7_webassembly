...
namespace mercury {
	static void convolve(std::vector<double>& result_mz, std::vector<double>& result_ab, const std::vector<double>& mz1, const std::vector<double>& ab1, const std::vector<double>& mz2, const std::vector<double>& ab2);
	static void prune(std::vector<double>& mz, std::vector<double>& ab, const double limit);
}


static void mercury::convolve(std::vector<double>& result_mz, std::vector<double>& result_ab, const std::vector<double>& mz1, const std::vector<double>& ab1, const std::vector<double>& mz2, const std::vector<double>& ab2)
{
	size_t n1 = mz1.size();
	size_t n2 = mz2.size();
	if ((n1+n2) == 0)
...
static void mercury::prune(std::vector<double>& mz, std::vector<double>& ab, const double limit) 
{
	size_t i;
	for (i = 0; i < ab.size(); i++) {
		if(ab[i] > limit)
